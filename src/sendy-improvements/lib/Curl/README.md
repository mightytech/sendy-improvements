...
![PHP Curl Class screencast](https://github.com/php-curl-class/php-curl-class/raw/master/www/img/screencast.gif)
...
### Sendy Improvements Changes
1. `\Curl\MultiCurl::queueHandle()` changed from private to protected